...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(
		...
		KC_LSFT, KC_TRNS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, MO(1), KC_UP,
		KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE, KC_RALT, KC_RWIN, MO(2), KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT),
    [1] = LAYOUT_all(
